...
import { Brain, FlaskConical, Home, Menu, Microscope, Network, User, X } from 'lucide-react'
            ...
            <div className="hidden md:flex lg:hidden items-center space-x-2 ml-4">
              ...
              {corePages.map(page => {
                ...
                return (
                  ...
                  >
                    <Icon className="h-4 w-4" />
                    <span className="hidden xl:inline">{page.name}</span>
                  </Link>
                )
              })}
            </div>
              ...
              <SheetContent side="right" className="w-80">
                <div className="flex items-center justify-between pb-4 mb-4 border-b">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-lg font-bold">Research Portfolio</span>
                  </div>
