  ...
  return (
    <div className="bg-red-50 border-2 border-red-400 rounded-lg p-4 min-w-[200px]">
      ...
      <div className="text-center mb-3">
        <div className="font-bold text-red-700 text-sm">Unsynchronized Raw Data</div>
      </div>
      ...
      <div className="text-center mt-2 text-xs text-red-600">❌ Clock drift & network latency</div>
    </div>
  )
}
...
function ProcessingStepNode({ data }: { data: any }) {
  ...
  return (
    <div className={`border-2 rounded-lg p-4 min-w-[200px] ${color}`}>
      ...
      />
      <Handle type="target" position={Position.Left} id="input" style={{ background: '#374151' }} />
      <Handle
        type="source"
  ...
  return (
    <div className="bg-green-50 border-2 border-green-500 rounded-lg p-4 min-w-[250px]">
      ...
      <div className="text-center mb-3">
        ...
        <div className="font-bold text-green-800 text-sm">Synchronized Data</div>
        <div className="text-xs text-gray-600 mt-1">Ready for Analysis</div>
      </div>
      <div className="space-y-2">
        <div className="bg-green-100 border border-green-300 rounded p-2">
          <div className="text-xs font-medium text-green-800">10:00:00, 10:01:00, 10:02:00...</div>
        </div>
        <div className="bg-green-100 border border-green-300 rounded p-2">
          <div className="text-xs text-green-600">Complete time coverage</div>
        </div>
        <div className="bg-green-100 border border-green-300 rounded p-2">
          <div className="text-xs text-green-600">No missing values</div>
        </div>
      </div>
    </div>
  )
...
export function TimeSyncPipelineDiagramFlow({ className = '' }: { className?: string }) {
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="mt-4 text-slate-700">
        <p className="mb-2">
          Our ETL pipeline effectively addresses the time-alignment hurdle by implementing a series
          of robust synchronization techniques.
        </p>
        <p className="mb-6">
          Through temporal bucketing, clock drift compensation, and advanced interpolation methods,
          we ensure that all meter readings are aligned to a common timeline, enabling accurate and
          reliable analysis.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-blue-50 border border-blue-300 rounded-lg p-4">
            <h4 className="font-bold text-blue-800 mb-3">Pipeline Benefits:</h4>
          ...
          <div className="bg-orange-50 border border-orange-300 rounded-lg p-4">
            <h4 className="font-bold text-orange-800 mb-3">Data Quality Assurance:</h4>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6 hidden">
          ...
          <div className="bg-violet-50 border border-violet-300 rounded-lg p-4">
            <h4 className="font-bold text-violet-800 mb-3">Scalability Features:</h4>
