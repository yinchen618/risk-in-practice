		...
		<div className="space-y-4">
			...
			<div className="flex items-end space-x-4">
				<div className="flex-1">
					...
					<Select
						value={
							selectedRunId === "new" || !selectedRunId
								? "new"
								: selectedRunId
						}
						...
						<SelectContent>
							<SelectItem value="new">
								<span className="text-muted-foreground">
									Please select an experiment run
								</span>
							</SelectItem>
					...
					>
						...
						<DialogContent>
							<DialogHeader>
								...
								<DialogDescription>
									Manage your experiment run and its
									associated data
								</DialogDescription>
							</DialogHeader>
							<div className="space-y-4">
								...
								<div className="bg-red-50 border border-red-200 rounded-lg p-4">
									...
									<ul className="text-sm text-red-700 list-disc list-inside space-y-1 mb-4">
										<li>
											All generated candidates (anomaly
											events)
										</li>
				...
				>
					...
					<DialogContent>
						<DialogHeader>
							...
							<DialogDescription>
								Create a new experiment run to begin the PU
								Learning workflow
							</DialogDescription>
						</DialogHeader>
						<div className="space-y-4">
							...
							<div>
								...
								<Textarea
									...
									onChange={(e) =>
										setNewRunDescription(e.target.value)
									}
									...
									<div className="flex items-center space-x-2">
										...
										<span>
											{(selectedRun.positive_label_count ||
												0) +
												(selectedRun.negative_label_count ||
													0)}{" "}
											/ {selectedRun.candidate_count}
										</span>
									</div>
