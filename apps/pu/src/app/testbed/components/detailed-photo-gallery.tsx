  ...
  return (
    <section className="mt-12 mb-8">
      ...
      <div className="text-center mb-8">
        <h2 className="text-2xl font-semibold text-slate-800 mb-2">Infrastructure in Detail</h2>
        <p className="text-slate-600">
          Additional perspectives on our comprehensive monitoring system
        </p>
      </div>
      ...
      <div className="text-center mt-6">
        <p className="text-xs text-slate-500 italic">
          Detailed infrastructure components supporting our real-time monitoring capabilities
        </p>
      </div>
    </section>
  )
