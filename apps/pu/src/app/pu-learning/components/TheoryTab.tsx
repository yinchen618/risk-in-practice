    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="p-6 bg-blue-50 rounded-lg">
        ...
        <p className="text-sm text-blue-700 mb-3">
          Reformulates classification risk to avoid needing labeled negatives, using class-prior π
      ...
      <div className="p-6 bg-purple-50 rounded-lg">
        ...
        <ul className="text-sm text-purple-700 space-y-1">
          <li>
            • PU learning reformulates binary classification using only positive and unlabeled data
          </li>
          <li>
            • The class-prior{' '}
          ...
          <li>
            • uPU uses <strong>Squared Loss</strong> with linear algebraic solution
          </li>
          <li>
            • nnPU uses{' '}
            <strong>
      ...
      <div className="p-6 bg-slate-50 rounded-lg">
        ...
        <p className="text-sm text-slate-700 mb-3">
          Risk estimators here are implemented exactly in our training pipeline. nnPU’s non-negative
