    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={value => updateDataParams({ distribution: value })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            ...
            <SelectItem value="two_moons">Two Moons (Challenging)</SelectItem>
            <SelectItem value="spiral">Spiral (Complex)</SelectItem>
            <SelectItem value="complex">Complex (Scikit-learn)</SelectItem>
          </SelectContent>
        </Select>
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="4">4D (Better performance)</SelectItem>
            <SelectItem value="8">8D (Optimal) ✅</SelectItem>
            <SelectItem value="16">16D (Best performance)</SelectItem>
            <SelectItem value="32">32D (High-dimensional)</SelectItem>
            <SelectItem value="50">50D (Very high-dimensional)</SelectItem>
          </SelectContent>
        </Select>
        <div className="text-xs text-gray-500">Higher dimensions = better classification</div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={value => updateDataParams({ nPositive: value[0] })}
          max={200}
          min={10}
          step={10}
          className="w-full"
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={value => updateDataParams({ nUnlabeled: value[0] })}
          max={500}
          min={50}
          step={25}
          className="w-full"
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={value => updateDataParams({ prior: value[0] })}
          max={0.8}
          min={0.1}
          step={0.05}
          className="w-full"
