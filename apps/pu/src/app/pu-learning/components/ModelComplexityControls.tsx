  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-gray-600 mb-2">Controls model capacity and complexity</p>
        <Slider
          value={[hiddenSize]}
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={value => onLearningRateChange(Number(value))}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            ...
            <SelectItem value="0.005">中 (Medium - Recommended)</SelectItem>
      ...
      {/* Activation Function */}
      <div className="space-y-2">
        <Label className="text-xs">激活函數 (Activation Function):</Label>
        <Select
        ...
        <div className="text-xs text-gray-500">
          {activationFunction === 'relu' && '最常用的激活函數，推薦使用'}
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="0.005">最佳 (Optimal - Recommended)</SelectItem>
        ...
        <div className="text-xs text-gray-500">
          ...
          {lambdaRegularization === 0.005 && '最佳正規化強度，推薦使用'}
