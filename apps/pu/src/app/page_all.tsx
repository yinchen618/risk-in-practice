...
export default function HomePage() {
  ...
  const coreImplementation = [
    {
      icon: BarChart3,
      title: '線性回歸',
      description: '從零開始實現線性回歸演算法，展現基礎機器學習的工程實力',
    ...
    },
    {
      icon: Target,
      title: 'Quick Draw AI',
      description: 'Google Quick Draw 風格的即時塗鴉識別遊戲，20秒挑戰模式',
      href: '/quickdraw',
      difficulty: '中級',
  ...
  const principleAnalysis = [
    {
      icon: Network,
      title: '神經網路視覺化',
      description: '逐層展示神經網路的內部運作，理解權重更新與特徵學習過程',
    ...
    },
    {
      icon: Zap,
      title: '反向傳播與梯度下降整合',
      description: '完整展示神經網路訓練的核心：如何結合反向傳播和梯度下降來優化參數',
    ...
    },
    {
      ...
      description: '完整的 Transformer 模型視覺化，從編碼器到解碼器的全流程',
  ...
  const frontierResearch = [
    {
      icon: FlaskConical,
      title: '互動式模型訓練',
      description: '可控的科學實驗平台：自訂超參數、損失函數，即時觀察訓練過程',
      href: '/model-training',
      difficulty: '研究級',
    ...
    },
    {
      icon: Microscope,
      title: '弱監督學習挑戰',
      description: '探索 PU Learning 與互補標籤學習，直接對應杉山教授的研究領域',
  ...
  const creativeInteraction = [
    ...
    },
    {
      icon: Gamepad2,
      title: '貪食蛇 AI 訓練',
      description: '觀察 Q-Learning 強化學習演算法如何訓練 AI 玩貪食蛇遊戲',
      href: '/games/snake',
      difficulty: '體驗',
      ...
      <CardHeader>
        ...
        {feature.academicValue && (
          <div className="mt-2 p-2 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-700 font-medium">學術價值：{feature.academicValue}</p>
          </div>
        )}
      </CardHeader>
      <CardContent>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mb-16 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8">
        <h2 className="text-2xl font-bold mb-4 text-center">平台設計理念</h2>
      ...
      <Tabs defaultValue="core" className="w-full">
        ...
        <TabsContent value="core">
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4">核心技術實作</h2>
            <p className="text-muted-foreground mb-6 text-lg">
              證明「我能建構一個完整的 AI 系統」—— 從演算法實現到 API 部署的完整工程能力展示
            </p>
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-amber-800 mb-2">🎯 學術價值</h4>
        ...
        <TabsContent value="principle">
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4">互動式原理剖析</h2>
            <p className="text-muted-foreground mb-6 text-lg">
              證明「我不只會調用，我懂底層原理」—— 展現對 AI 模型內部運作機制的深刻理解
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-blue-800 mb-2">🎯 學術價值</h4>
        ...
        <TabsContent value="research">
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4">前沿研究探索</h2>
            <p className="text-muted-foreground mb-6 text-lg">
              證明「我具備研究潛力」—— 展現將前沿理論轉化為研究工具的能力，為博士研究做準備
            </p>
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-red-800 mb-2">🎯 學術價值</h4>
        ...
        <TabsContent value="creative">
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4">創意互動體驗</h2>
            <p className="text-muted-foreground mb-6 text-lg">
              展現「AI 技術的創新應用」—— 從實用功能到前沿技術的多元化展示
            </p>
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-green-800 mb-2">🎯 學術價值</h4>
              <p className="text-green-700 text-sm">
                展現您對 AI 技術廣度的掌握和創新應用的思維。這些項目展現您緊跟前沿技術發展，
                具備將理論轉化為實際應用的能力。
              </p>
            </div>
          </div>
      ...
      <div className="mt-16 text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl p-12">
        <h2 className="text-3xl font-bold mb-4">開始探索 AI 的無限可能</h2>
        <p className="text-xl mb-8 opacity-90">
          每個模組都是一個完整的學習體驗，從基礎概念到前沿研究，循序漸進地建構您的 AI 知識體系
        </p>
