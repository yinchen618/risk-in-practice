...
import { profitSharingFormSchema, type ProfitSharingFormData } from "./shared/types";
import { 
	formatCurrency, 
	formatPercentage, 
...
export function CreateProfitSharingDialog({
	...
	}, [form.watch("customerId"), customers, fetchBankAccounts, fetchRMsAndFinders]);
					...
					<form onSubmit={form.handleSubmit(onSubmit)}>
						...
						<DialogFooter>
							...
							<Button 
								...
								disabled={
									isLoading || 
									!isValidProfitSharePercent(totalProfitSharePercent)
								}
							>
								{isLoading ? "新增中..." : "新增"}
							</Button>
